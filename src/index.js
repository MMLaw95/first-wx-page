...
// let displayStar = document.querySelector("#star-city");

// displayStar.innerHTML = inputCity.value;
...
//   let location = console.log(position.coords.latitude);
...
// let coordKey = "a4291214a1e333b12b6de7b256df44ea";
// let lat = position.coords.latitude;
// let lon = position.coords.longitude;
// let coordUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${coordKey}`;
